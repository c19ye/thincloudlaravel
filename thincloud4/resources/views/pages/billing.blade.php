                ...
                <div class="bs-stepper register-multi-steps-wizard shadow-none">
                  ...
                  <div class="bs-stepper-content px-0 mt-4">
                    ...
                    >
                      ...
                      <form method="POST" action="/mythincloud/billing/store">
                        @csrf
                        <div class="row">
                    ...
                    >
                      <div class="content-header mb-2">
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                            <div class="mb-1 col-md-6">
                              <label class="form-label" for="toll_address"
                                >Toll Adresi</label
                              >
                              <input
                                type="text"
                            ...
                            <div class="mb-1 col-md-6">
                              <label class="form-label" for="toll_number"
                                >Toll Numarası</label
                              >
                              <input
                                type="text"
                          ...
                          <div class="col-md-6 mb-1">
                            ...
                            <input
                              ...
                              name="zip_code"
                              id="zip_code"
                              class="form-control zip_code-mask"
                              placeholder="Kod"
                              maxlength="6"
                            />
                          </div>
                          ...
                          <div class="col-md-6 mb-1">
                            <label class="form-label" for="bill_email"
                              >E-posta</label
                            >
                            <input
                              type="email"
