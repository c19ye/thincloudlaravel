...
<link
    ...
    <link
      rel="shortcut icon"
      type="image/x-icon"
      href={{asset("app-assets/images/ico/favicon.icoo")}}
    />
    <link
                      ...
                      >
                        <div class="card">
                          ...
                          <div class="card-body my-1 py-25">
                            <form method="POST" action="/account-settings-billing/add_creditCard">
                              @csrf
                            <div class="row gx-4">
                              <div class="col-lg-6">
                                  <div class="col-12 mt-2">
                                    ...
                                    <div class="input-group input-group-merge">
                                      <input
                                        ...
                                        data-msg="Kredi kart numaranızı giriniz"
                                      />
                                      <span
                                    ...
                                    >
                                      <div class="card-information">
                                        <img
                                          ...
                                          src={{asset("app-assets/images/icons/payments/mastercard.png")}}
                                          alt="Master Card"
                                        />
                                        <div
                                  ...
                                  <div class="cardMaster border rounded p-2">
                                    ...
                                    >
                                      <div class="card-information">
                                        <img
                                          class="mb-1 img-fluid"
                                          src={{asset("app-assets/images/icons/payments/visa.png")}}
                                          alt="Visa Card"
                                        />
                        ...
                        <div class="card">
                          ...
                          <div class="card-body my-2 py-50">
                            <form
                              ...
                              class="validate-form"
                            >
                            <form method="POST" action="/account-settings-billing/update_billing">
                              @csrf
                              <div class="row">
...
@section("js")
    ...
    <script src={{asset("app-assets/js/scripts/pages/modal-edit-cc.js")}}></script>
