              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <?php else: ?>
                      <?php $__currentLoopData = $filehub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          <td><?php echo e($file->name); ?></td>
                          <td><?php echo e($file->name); ?></td>
                          <td><?php echo e($file->storage_size); ?> GB</td>
                          <td>
                  ...
                  <div class="tab-content">
                    ...
                    >
                      ...
                      <div class="col-12">
                        ...
                        <div class="col-12 d-md-flex justify-content-center">
                          <?php if(count($virtual) == 0): ?>
                            <p>Kayıtlı thincloudınız bulunmuyor!</p>
                          <?php else: ?>
                            <?php $__currentLoopData = $virtual; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $virt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check form-check-inline">
                              <input
                                class="form-check-input"
                                type="checkbox"
                ...
                <?php if(count($filehub) == 0): ?>
                  ...
                  <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="inlineCheckbox13"
                      ><?php echo e($file->name); ?></label
                    >
                  </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php $__errorArgs = ['add_filehub_select'];
            ...
            <div class="col-12">
              ...
              <div class="col-12 d-md-flex justify-content-center">
                ...
                <?php $__currentLoopData = $virtual; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $virt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php $__errorArgs = ['add_filehub_vm'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="col-12">
              ...
              <div class="col-12 d-md-flex justify-content-center">
                ...
                <?php else: ?>
                  ...
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <?php $__errorArgs = ['add_filehub_departman'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\thincloud3\resources\views/pages/filehubs.blade.php ENDPATH**/ ?>