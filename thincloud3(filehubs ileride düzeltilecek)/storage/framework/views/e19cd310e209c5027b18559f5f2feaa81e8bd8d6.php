        ...
        <div class="main-menu-content" >
            <ul class="text-center mt-2">
                ...
                <li class="nav-item mt-50">
                    <span class="user-name fw-bolder text-white opacity-75"><?php echo e(auth()->user()->name); ?>

                        <?php echo e(auth()->user()->surname); ?></span>
                </li>
            </ul>
            <ul class="navigation navigation-main mt-3" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item <?php echo e(Route::is('index') ? 'active' : ''); ?>">
                    <a class="d-flex align-items-center" href=<?php echo e(route('index')); ?>><i data-feather="home"></i><span
                ...
                <li class="nav-item <?php echo e(Route::is('ticket') ? 'active' : ''); ?> mb-5">
            ...
            width: 100%;">
                        ...
                        <a class="align-items-center ms-1 text-white" style="width: 50px;height: 40px;" href=<?php echo e(route('inbox')); ?>> <i data-feather="mail" style="height: 23px;width: 23px"></i></a>


                    <a class=" align-items-center text-white" style="width: 50px;height: 40px;" href=<?php echo e(route('account-settings-account')); ?>> <i
    ...
    <!-- END: Main Menu-->
<?php /**PATH C:\xampp\htdocs\thincloud3\resources\views/sabit/menu.blade.php ENDPATH**/ ?>