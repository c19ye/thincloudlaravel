          ...
          <li class="nav-item dropdown dropdown-user">
            ...
            >
              ...
              <div class="user-nav d-sm-flex d-none">
                <span class="user-name fw-bolder"><?php echo e(auth()->user()->name); ?> <?php echo e(auth()->user()->surname); ?></span
            ...
            >
              <a class="dropdown-item" href=<?php echo e(route("inbox")); ?>

                ><i class="me-50" data-feather="mail"></i> Gelen Kutusu</a
              ><a class="dropdown-item" href=<?php echo e(route("account-settings-account")); ?>
    ...
    <ul class="main-search-list-defaultlist d-none">
      <li class="d-flex align-items-center">
        <a href="#">
          <h6 class="section-label mt-75 mb-0">Dosyalarım</h6>
        </a>
      </li>
    ...
    <!-- END: Header-->
<?php /**PATH C:\xampp\htdocs\thincloud3\resources\views/sabit/nav.blade.php ENDPATH**/ ?>