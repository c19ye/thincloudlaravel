        ...
        <div class="content-body">
          <div class="auth-wrapper auth-cover">
            <div class="auth-inner row m-0">
              <!-- Brand logo--><a class="brand-logo" href=<?php echo e(route("index")); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <button class="btn-sm btn-primary w-100" type="submit" tabindex="4">
                      Giriş Yap
                    </button>
                  </form>
...
<?php echo $__env->make("layout2", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\thincloud3\resources\views/auth/login.blade.php ENDPATH**/ ?>