              ...
              <div class="col-12 d-md-flex justify-content-center">
                ...
                <div class="form-check form-check-inline">
                  <input
                    class="form-check-input"
                    type="checkbox"
                    id="inlineCheckboxfdc2"
                    value="unchecked"
                  />
                  <label class="form-check-label" for="inlineCheckboxfdc2"
                    >FileHub 2</label
                  >
                </div>
                <div class="form-check form-check-inline">
                  <input
                    class="form-check-input"
                    type="checkbox"
                    id="inlineCheckboxfdc3"
                    value="unchecked"
                  />
                  <label class="form-check-label" for="inlineCheckboxfdc3"
                    >FileHub 3</label
                  >
                </div>
              </div>
