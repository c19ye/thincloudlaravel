                        ...
                        <div class="row">
                                ...
                                <div class="d-flex justify-content-between flex-column mb-2 mb-md-0 overflow-auto pe-2">
                                    ...
                                    <ul class="nav nav-pills nav-left flex-column" role="tablist">
                                        ...
                                        <li class="nav-item mb-2">
                                            <a class="nav-link active" id="vm1" data-bs-toggle="pill"
                                        ...
                                        <li class="nav-item mb-2">
                                            <a class="nav-link" id="vm2" data-bs-toggle="pill" href="#myplans-vm2"
                                        ...
                                        <li class="nav-item mb-2">
                                            <a class="nav-link" id="vm3" data-bs-toggle="pill" href="#myplans-vm3"
                                                aria-expanded="true" role="tab">
                                                <i data-feather="server"></i>
                            ...
                            <div class="col-lg-10 col-md-12 col-sm-12">
                                ...
                                <div class="tab-content">
                                    ...
                                    <!-- VM-2 -->
                                    <div class="tab-pane" id="myplans-vm2" role="tabpanel" aria-labelledby="vm2"
                                        aria-expanded="false">
                                        <div class="row pricing-card">
                                            <div
                                                class="col-12 col-sm-offset-2 col-sm-10 col-md-12 col-lg-offset-2 col-lg-12 mx-auto">
                                    ...
                                    <!-- VM-3  -->
                                    <div class="tab-pane" id="myplans-vm3" role="tabpanel" aria-labelledby="vm3"
                                        aria-expanded="false">
                                        <div class="row pricing-card">
                                            <div
                                                class="col-12 col-sm-offset-2 col-sm-10 col-md-12 col-lg-offset-2 col-lg-12 mx-auto">
