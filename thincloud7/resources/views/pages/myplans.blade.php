                ...
                <div class="content-body">
                    <div class="col-12">
                        <div class="card bg-primary text-white text-center mb-3">
                            <div class="card-body">
                                <h4 class="card-title text-white">Sanal Makine Bulunamadı!</h4>
                                <p class="card-text">Henüz bir sanal makineniz yok. Bir sanal makine oluşturmak ister misiniz?</p>
                                <a href="{{route('virtualmachines')}}" class="btn btn-success col-3">Oluştur</a>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-3">
                                                        <div class="card basic-pricing text-center">
                                                            ...
                                                            <a href={{$virt == null ? "#": '/mythincloud/billing/1'}} class="plan_id" id="1">
                                                    ...
                                                    <div class="col-12 col-md-3">
                                                        <div class="card standard-pricing text-center">
                                                            ...
                                                            @else
                                                            <a href={{$virt == null ? "#": '/mythincloud/billing/2'}} class="plan_id" id="2">
                                                            <button class="btn btn-primary m-2">
                                                                Güncelle
                                                            </button>
                                                            </a>
                                                    ...
                                                    <div class="col-12 col-md-3">
                                                        <div class="card enterprise-pricing text-center">
                                                            ...
                                                            @else
                                                            <a href={{$virt == null ? "#": '/mythincloud/billing/3'}} class="plan_id" id="3">
                                                                <button class="btn btn-primary m-2">
                                                                    Güncelle
                                                                </button>
                                                                </a>
                                                    ...
                                                    <div class="col-12 col-md-3">
                                                        <div class="card basic-pricing text-center">
                                                            ...
                                                            @else
                                                            <a  href={{$virt == null ? "#": '/mythincloud/billing/4'}} class="plan_id" id="4">
                                                                <button class="btn btn-primary m-2">
                                                                    Güncelle
                                                                </button>
                                                                </a>
