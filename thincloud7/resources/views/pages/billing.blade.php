...
<link
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href={{asset("app-assets/css/pages/authentication.css")}}
    />
    <!-- END: Page CSS-->
                ...
                <div class="bs-stepper register-multi-steps-wizard shadow-none">
                  ...
                  <div class="bs-stepper-content px-0 mt-4">
                    ...
                    >
                      ...
                      <form action="/mythincloud/billing/postinformations" method="POST" id="form1">
                        @csrf
                        <input type="hidden" value="{{$id}}" name="get_planid">
                        <div class="row">
                    ...
                    >
                      <div class="content-header mb-2">
                        ...
                        <div class="row">
                          ...
                          <div class="mb-1 col-md-6">
                            <label for="select_city" class="form-label">Şehir</label>
                            <select name="city" class="form-select" id="select_city">
                          ...
                          <div class="mb-1 col-md-6">
                            <label for="select_state" class="form-label">İlçe</label>
                            <select name="district" class="form-select" id="select_state">
                              <option value="cankaya">Çankaya</option>
                              <option value="eti">Etimesgut</option>
                              <option value="bag">Bağcılar</option>
                              <option value="yen">Yenimahalle</option>
                              <option value="üs">Üsküdar</option>
                            </select>
                          </div>
                          <div class="col-md-6 mb-1">
