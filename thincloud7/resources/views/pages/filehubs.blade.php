                  ...
                  <div class="tab-content">
                    ...
                    >
                      ...
                      <div class="col-12">
                        ...
                        />
                        @if ($errors->createfilehub->first("name") != "")
                        ...
                        >
                          <div class="form-check form-check-inline">
                            <input
                              ...
                              checked
                            />
                            <label class="form-check-label" for="storage_option1"
                              >10GB</label
                            >
                          </div>
                          <div class="form-check form-check-inline">
                            <input
                              ...
                              value="20"
                            />
                            <label class="form-check-label" for="storage_option2"
                              >20GB</label
                            >
                          </div>
                          <div class="form-check form-check-inline">
                            <input
                              ...
                              value="30"
                            />
                            <label class="form-check-label" for="storage_option3"
                              >30GB</label
                            >
                          </div>
                          <div class="form-check form-check-inline">
                            <input
                              ...
                              value="40"
                            />
                            <label class="form-check-label" for="storage_option4"
                              >40GB</label
                            >
                          </div>
                          <div class="form-check form-check-inline">
                            <input
                              ...
                              value="50"
                            />
                            <label class="form-check-label" for="storage_option5"
                              >50GB</label
                            >
                          </div>
                        </div>
                        @if ($errors->createfilehub->first("storage_size") != "")
                        <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                            <div class="alert-body d-flex align-items-center">
                                <i data-feather="info" class="me-50"></i>
                      ...
                      <div class="col-12">
                        ...
                        @if ($errors->createfilehub->first("backup_time") != "")
                        <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                            <div class="alert-body d-flex align-items-center">
                                <i data-feather="info" class="me-50"></i>
                    ...
                    >
                      <div class="col-12">
                        ...
                        @if ($errors->createfilehub->first("select_departmans") != "")
                        <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                            <div class="alert-body d-flex align-items-center">
                                <i data-feather="info" class="me-50"></i>
                      ...
                      <div class="col-12">
                        ...
                        @if ($errors->createfilehub->first("select_vms")!= "")
                        <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                            <div class="alert-body d-flex align-items-center">
                                <i data-feather="info" class="me-50"></i>
        ...
        <div class="modal-body pb-5 px-sm-4 mx-50">
          ...
          @csrf
            <div class="col-12">
              ...
              @if ($errors->adduser->first("add_filehub") != "")
                        <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                            <div class="alert-body d-flex align-items-center">
                                <i data-feather="info" class="me-50"></i>
            ...
            <div class="col-12">
                ...
                @foreach ($virtual as $virt)
                  <div class="form-check form-check-inline">
                    <input
                      ...
                      type="checkbox"
                      name="add_vm[]"
                      id="inlineCheckboxx{{$virt->id}}"
                      value="{{$virt->id}}"
                      unchecked
                    />
                    <label class="form-check-label" for="inlineCheckboxx{{$virt->id}}"
                      >{{$virt->name}}</label
                    >
                  </div>
                  @endforeach
              ...
              @if ($errors->adduser->first("add_vm") != "")
              <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                  <div class="alert-body d-flex align-items-center">
                      <i data-feather="info" class="me-50"></i>
          ...
          @endif
            ...
            <div class="col-12">
                  ...
                  @foreach ($departman as $dep)
                    <div class="form-check form-check-inline">
                      <input
                        ...
                        type="checkbox"
                        name="add_departman[]"
                        id="iinlineCheckbox{{$dep->id}}"
                        value="{{$dep->id}}"
                        unchecked
                      />
                      <label class="form-check-label" for="iinlineCheckboxx{{$dep->id}}"
                        >{{$dep->name}}</label
                      >
                    </div>
                  @endforeach
              ...
              @if ($errors->adduser->first("add_departman") != "")
                        <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                            <div class="alert-body d-flex align-items-center">
                                <i data-feather="info" class="me-50"></i>
        ...
        <div class="modal-body pb-5 px-sm-4 mx-50">
          ...
          @csrf
            <div class="col-12">
              ...
              @if ($errors->downloadfilehub->first("download_filehub"))
              <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                  <div class="alert-body d-flex align-items-center">
                      <i data-feather="info" class="me-50"></i>
            ...
            <div class="col-12">
              ...
              @if ($errors->downloadfilehub->first("location") != "")
              <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                  <div class="alert-body d-flex align-items-center">
                      <i data-feather="info" class="me-50"></i>
