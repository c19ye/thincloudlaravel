...
@section('css')
    ...
    <link rel="shortcut icon" type="image/x-icon" href="../../../app-assets/images/ico/favicon.icoo" />
                ...
                <div class="misc-wrapper">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            <h2 class="mb-1">Bakımdayız 🛠</h2>
                            <p class="mb-3">
                                Rahatsızlık için özür dileriz ama şu anda bazı bakım
                                yapıyoruz...
                            </p>
                            ...
                            <img class="img-fluid" src="../../../app-assets/images/pages/under-maintenance-dark.svg"
