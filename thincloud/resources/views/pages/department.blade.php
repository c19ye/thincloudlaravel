                    ...
                    <tr>
                      ...
                      <td>
                        @foreach ($domains as $domain)
                            ...
                            @if ($domain->department_id == $department->id)
                                {{$domain->name}}
                            @endif
                        @endforeach
                      </td>
        ...
        <div class="modal-body pb-5 px-sm-4 mx-50">
          ...
          <div class="row">
            ...
            <div class="mb-1">
              ...
              >
              <select name="domain_id" class="form-select" id="select-domain" required>
                  @foreach ($domains as $domain)
          ...
          <div class="row">
            ...
            id="du{{$number}}"
          />
          <label class="form-check-label" for="du{{$number}}">{{$thincloud->thincloudname}}</label>
          <br />
            ...
            <div class="col-12">
              <div class="mb-1">
                <label class="form-label" for="select-country1"
                  >FileHub Seçme</label
                >
                <select name="filehub_id" class="form-select" id="select-filehub" required>
